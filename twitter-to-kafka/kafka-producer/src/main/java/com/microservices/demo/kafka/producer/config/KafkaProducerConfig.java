...
import com.microservices.demo.twitter.to.kafka.config.KafkaProducerConfigData;
...
public class KafkaProducerConfig <K extends Serializable, V extends SpecificRecordBase> {
    ...
    public Map<String, Object> producerConfig(){
        ...
        props.put(ProducerConfig.ACKS_CONFIG, kafkaProducerConfigData.getCompressionType());
