package com.microservices.demo.twitter.to.kafka.consumer.config;
...
public class KafkaConsumerConfig <K extends Serializable, V extends SpecificRecordBase>{
    ...
    public Map<String, Object> consumerConfigs(){
        ...
        props.put(ConsumerConfig.HEARTBEAT_INTERVAL_MS_CONFIG, kafkaConsumerConfigData.getMaxPollIntervalMs());
